...
const Appointment = () => {
  return (
    <div className="flex flex-col gap-2 my-5">
      <h2 className="text-black text-4xl max-sm:text-base font-medium">
        Steps to book an appointment
      </h2>
      <div className="opacity-50 text-black text-lg max-sm:text-[10px] font-normal mb-2">
        4 Simple steps to book an appointment with the lawyer.
      </div>
      <div className="grid grid-cols-4 max-lg:grid-cols-2 gap-3">
        ...
        >
          ...
          <p className="text-slate-50 text-lg max-sm:text-[10px] font-normal my-3 leading-normal">
            Search for lawyer in required area of practice.
          </p>
        </div>
        <div
          className="w-full h-full rounded-2xl p-3"
        ...
        >
          ...
          <p className="text-slate-50 text-lg max-sm:text-[10px] font-normal my-3 leading-normal">
            Select the date and time to reserve a spot for consultation.
          </p>
        </div>
        <div
          className="w-full h-full rounded-2xl p-3"
        ...
        >
          ...
          <p className="text-slate-50 text-lg max-sm:text-[10px] font-normal my-3 leading-normal">
            The payment mode of user is safe and secure.
          </p>
        </div>
      </div>
    </div>
