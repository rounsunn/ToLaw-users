  ...
  return (
    <div className="w-full flex justify-between p-4 my-5 bg-[#0C253F] rounded-lg text-white shadow-xl shadow-slate-800">
      <div className="flex flex-col gap-3 w-1/2">
        <h1 className="text-3xl max-sm:text-lg tracking-wide leading-wide">
          Talk to Experts
        </h1>
        <div className="flex items-center gap-3 max-sm:gap-1 ">
          <div className="w-2 h-2 max-sm:w-[5px] max-sm:h-[5.70px] bg-white rounded-full" />
          <p className="opacity-60 text-slate-50 text-lg tracking-wider max-sm:text-xs font-normal">
            Access to Expertise
          </p>
        </div>
        <div className="flex items-center gap-3 max-sm:gap-1 ">
