  ...
  return (
    <div className="font-poppins p-8 mt-4 bg-[#0C253F] text-white flex w-full justify-evenly">
        <div className="flex flex-col gap-1 text-[12px]">
            <Link to="/search" className="hover:underline">Search lawyers</Link>
            <Link to="/aiassit" className="hover:underline">Talk to AI</Link>
        ...
        <div className="flex flex-col items-center gap-1 text-[15px]">
            ...
            <p>For any queries, feel free to reach out - <Link to="mailto:mail@tolaw.in">mail@tolaw.in</Link></p>
        </div>
